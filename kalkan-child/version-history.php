	...
	<main class="kk-main">
		...
		<div class="kk-page-content"><div class="kk-shell" style="max-width:56rem;">
			...
			<div class="kk-release-list">
				...
				<article id="version-1-0-5" class="kk-release kk-glass">
				...
				<article id="version-1-0-4" class="kk-release kk-glass">
				...
				<article id="version-1-0-3" class="kk-release kk-glass">
				...
				<article id="version-1-0-2" class="kk-release kk-glass">
				...
				<article id="version-1-0-1" class="kk-release kk-glass">
