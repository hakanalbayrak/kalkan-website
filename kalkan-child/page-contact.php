			...
			<div class="kk-shell">
				...
				<div class="kk-page-content" style="max-width:40rem;margin:0 auto 2rem;padding:0;">
					<?php if ('tr' === $lang) : ?>
						...
						<p>Destek taleplerini yalnızca hizmeti incelemek ve yanıtlamak için kullanırız. Kalkan rehberinize, arama sesine veya kişisel arama geçmişinize erişmez. Yanıt süresi talebin kapsamına göre değişebilir; aynı konu için birden fazla form göndermek incelemeyi hızlandırmaz. Uygulama içi satın alma ve iade işlemleri Apple tarafından yönetildiği için bu taleplerde App Store işlem bilgilerinizi kontrol etmeniz gerekebilir; tam ödeme kartı bilgilerinizi bize göndermeyin.</p>
					<?php else : ?>
