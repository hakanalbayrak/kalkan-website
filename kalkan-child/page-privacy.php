...
<meta name="description" content="<?php echo esc_attr( $__( 'Kalkan gizlilik politikası. Kişisel verilerinizin nasıl korunduğunu öğrenin.', 'Kalkan privacy policy. Learn how your personal data is protected.' ) ); ?>">
<meta property="og:title" content="<?php echo esc_attr( $page_title ); ?>">
<meta property="og:description" content="<?php echo esc_attr( $__( 'Kalkan gizlilik politikası.', 'Kalkan privacy policy.' ) ); ?>">
